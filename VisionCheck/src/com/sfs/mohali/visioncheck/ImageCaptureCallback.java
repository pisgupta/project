...
//		tvDisplayDate.setText(dateString);
		String photoFile = "Picture" +counter+ dateString + ".jpg";
        Log.e("Picture name",photoFile);
		...
		try {
			...
			fos.close();
			CameraTest.progressDialog.dismiss();
			...
			File f = new File(Environment.getExternalStorageDirectory()
					.getPath()
					+ "/Pictures/CameraAPIDemo/Picture"+counter+ dateString+ ".jpg");
			...
			if (counter > 0 && counter <= 4) { // counter is incremented before
				...
				bmp = null;
				// up-to here
				CameraTest.iv.setImageBitmap(rImg);
				try {
