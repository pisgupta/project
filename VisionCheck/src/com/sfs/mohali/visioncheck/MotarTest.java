...
public class MotarTest extends Activity implements OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TexttoSpeech = new TextToSpeech(MotarTest.this,
		...
		cameracapture.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(MotarTest.this, CameraTest.class);
	...
	/**
	 * This timer task is used to show the user a count down timer.
	 */
		...
		public void run() {
			runOnUiThread(new Runnable() {
				...
				public void run() {
					int j = 16 - i;
					if (j == 5) {
						five = new TextToSpeech(MotarTest.this,
								new TextToSpeech.OnInitListener() {
					...
					if (j == 4) {
						five.shutdown();
						five.stop();
						four = new TextToSpeech(MotarTest.this,
								new TextToSpeech.OnInitListener() {
					...
					if (j == 3) {
						four.shutdown();
						four.stop();
						three = new TextToSpeech(MotarTest.this,
								new TextToSpeech.OnInitListener() {
					...
					if (j == 2) {
						three.shutdown();
						three.stop();
						two = new TextToSpeech(MotarTest.this,
								new TextToSpeech.OnInitListener() {
					...
					if (j == 1) {
						two.shutdown();
						two.stop();
						one = new TextToSpeech(MotarTest.this,
								new TextToSpeech.OnInitListener() {
					...
					if (j == 0) {
						one.shutdown();
						one.stop();
						zero = new TextToSpeech(MotarTest.this,
								new TextToSpeech.OnInitListener() {
			...
			if (i > 15) {
				...
				layout.setOnTouchListener(MotarTest.this);
	...
	private void addImageView() {
		runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				imageView = new ImageView(MotarTest.this);
				imageView.setImageResource(R.drawable.ball);
		...
		alertDialogBuilder
				...
				.setNegativeButton("No", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int id) {
						...
						TexttoSpeech.stop();
						Intent intent = new Intent(MotarTest.this,
								StartTest.class);
						startActivity(intent);
						finish();
					}
