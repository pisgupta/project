...
Camera.PictureCallback {
	...
	String titlespeech5 = ".....Please take the clear picture of the pills prescribed by your physician.Make sure all the pills are clearly visible.";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		switch (ImageCaptureCallback.counter) {
		case 1:
			...
			grid = (ImageView) view.findViewById(R.id.imageeyegrid);
		...
		case 2:
			...
			grid = (ImageView) view1.findViewById(R.id.imagerighteyegrid);
			grid.setScaleType(ScaleType.FIT_XY);
		...
		case 3:
			...
			grid = (ImageView) view2.findViewById(R.id.imagelefteyegrid);
			grid.setScaleType(ScaleType.FIT_XY);
		...
		TexttoSpeech = new TextToSpeech(CameraTest.this,
		...
		case 1:
			...
			TexttoSpeech1 = new TextToSpeech(CameraTest.this,
					new TextToSpeech.OnInitListener() {
		...
		case 2:
			...
			TexttoSpeech2 = new TextToSpeech(CameraTest.this,
					new TextToSpeech.OnInitListener() {
		...
		case 3:
			...
			TexttoSpeech3 = new TextToSpeech(CameraTest.this,
					new TextToSpeech.OnInitListener() {
		...
		case 4:
			...
			TexttoSpeech4 = new TextToSpeech(CameraTest.this,
					new TextToSpeech.OnInitListener() {
		...
		case 5:
			textviewmedicine
					.setText("Please take the clear picture of the pills prescribed by your physician.Make sure all the pills are clearly visible.");
			TexttoSpeech5 = new TextToSpeech(CameraTest.this,
					new TextToSpeech.OnInitListener() {
		...
		surfaceView.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_UP:
					...
					camera.takePicture(null, null, new ImageCaptureCallback(
					...
					progressDialog = new ProgressDialog(CameraTest.this);
