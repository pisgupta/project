...
public class SelectButton2 extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) 
	{
			...
			setContentView(R.layout.selectbutton2);
		    ...
		    if(R.id.image2 == ColorTest2.image2.getId())
		    {
		        ...
		        button1.setOnClickListener(new View.OnClickListener() 
		        {
					...
					public void onClick(View v) {
						...
						{
							SelectButton1.spedit.putString("textvalue1", "null");

							Intent mIntent = new Intent(SelectButton2.this, ColorTest3.class);
						...
						{
							SelectButton1.spedit.putString(
									"textvalue1",
									"Failed in Question 2- Normal and those with colour deficients should see the number 15.");
			...
			alertDialogBuilder
					...
					.setNegativeButton("No", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							...
							Intent intent = new Intent(SelectButton2.this,
								StartTest.class);
